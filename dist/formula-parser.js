...
exports.SUMIF = function(range, criteria, target) {
  ...
  criteria = validCriteria(criteria);
...
exports.SUMIFS = function() {
  var args = utils.argsToArray(arguments);
  var target = utils.parseNumberArray(utils.flatten(args.shift()));
  ...
  for (var i = 0; i < len; i += 2) {
    ranges.push(utils.flatten(args[i]));
    criterias.push(validCriteria(args[i + 1]))
  }

  var n_range_elements = target.length;
  var n_criterias = len / 2;
