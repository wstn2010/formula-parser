...
```sh
$ npm install qron-formula-parser --save
```

Node.js:
```js
var FormulaParser = require('qron-formula-parser').Parser;
...
Browser:
```html
<script src="/node_modules/qron-formula-parser/dist/formula-parser.min.js"></script>
<script>
...
**Note:** New feature 'Sheet reference' has not been reflected yet in the following descriptions.  
 ...
 * All excel formulas defined in [formula.js](https://github.com/wstn2010/formula.js);
...
```js
require('qron-formula-parser').SUPPORTED_FORMULAS; // An array of formula names
```
...
To see the list of recent changes, see [Releases section](https://github.com/wstn2010/formula-parser/releases).

### License

The MIT License (see the [LICENSE](https://github.com/wstn2010/formula-parser/blob/master/LICENSE) file for the full text).

### Contact

You can contact us at wstn2010@gmail.com.
